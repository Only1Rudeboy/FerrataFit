...
/** WEIGHT = Last steigern, REPS = erst Wiederholungen dann Zusatzlast, TIME = Haltezeit. */
...
export const EXERCISES = [
  // ---------- Tag A: Zug & Griffkraft ----------
  {
    ...
    cue: 'Schulterblätter zuerst nach unten ziehen, dann erst die Arme beugen. Wenn du noch keinen sauberen schaffst: Sprung nach oben und 5 Sekunden langsam ablassen.',
  ...
  },
  {
    ...
    cue: 'Locker hängen, Schultern aktiv nach unten ziehen (nicht in den Gelenken hängen). Abbrechen, bevor der Griff komplett aufgeht.',
  ...
  // ---------- Tag B: Beine & Steigkraft ----------
  {
    ...
    cue: 'Stufe möglichst kniehoch. Ganzes Gewicht auf den oberen Fuß, nicht mit dem hinteren Bein abdrücken. Langsam ablassen.',
