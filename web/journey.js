...
export const MOBILITY = [
  {
    ...
    steps: [
      'Arm auf Schulterhöhe nach vorne strecken, Handfläche zeigt nach vorne wie beim Stopp-Zeichen.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Mit der anderen Hand über den Handrücken fassen und die Hand sanft zu dir und nach innen ziehen.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Einen kleinen Schritt nach vorne machen und den Oberkörper langsam von der Hand wegdrehen.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Einen Schritt zurücktreten und das Gesäß nach hinten schieben, bis die Arme lang sind.',
      'Den Kopf zwischen die Arme sinken lassen, Rücken lang machen.',
      'Für mehr Wirkung leicht zu einer Seite verlagern — dann spürst du die Flanke deutlicher.',
    ],
    mistakes: [
  ...
  },
  {
    ...
    steps: [
      'In einen tiefen Ausfallschritt gehen und das hintere Knie auf dem Boden ablegen (Matte oder Kissen drunter).',
      'Oberkörper aufrecht aufrichten, Hände auf dem vorderen Knie oder in der Hüfte.',
      'Jetzt das Gesäß der hinteren Seite fest anspannen und das Becken leicht nach vorne schieben.',
      'Die Dehnung liegt vorne in der Hüfte des hinteren Beins. Halten, dann Seite wechseln.',
    ],
    mistakes: [
      'Ins Hohlkreuz gehen statt das Becken aufzurichten. Genau deshalb das Gesäß anspannen — das kippt das Becken richtig.',
  ...
  },
  {
    ...
    steps: [
      'Aus dem Vierfüßlerstand ein Bein nach vorne bringen und angewinkelt ablegen — Knie hinter dem Handgelenk, Unterschenkel quer.',
      'Das hintere Bein lang nach hinten strecken, Fußrücken liegt auf.',
      'Becken gerade halten und langsam absinken lassen. Bei Bedarf ein Kissen unter die vordere Gesäßhälfte.',
      'Aufrecht bleiben oder den Oberkörper nach vorne ablegen. Halten, dann Seite wechseln.',
    ],
    mistakes: [
      'Das Becken zur Seite kippen lassen. Lieber ein Kissen unterlegen und gerade bleiben.',
      'Ins vordere Knie drücken, wenn es zwickt. Bei Knieproblemen lieber die Variante im Liegen wählen.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Das hintere Bein leicht beugen und das Gesäß nach hinten schieben — wie bei einer Verbeugung aus der Hüfte.',
      'Der Rücken bleibt gerade. Du spürst die Dehnung hinten im vorderen Oberschenkel.',
      'Halten, dann Seite wechseln.',
    ],
    mistakes: [
      'Den Rücken runden und mit den Händen zum Fuß greifen. Die Bewegung kommt aus der Hüfte, nicht aus dem Rücken.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Halten. Für die tiefere Wadenmuskulatur das hintere Knie leicht beugen und nochmal halten.',
      'Seite wechseln.',
    ],
    mistakes: [
  ...
  },
  {
    ...
    steps: [
      ...
      'Einatmen und dabei den Rücken sanft ins leichte Hohlkreuz sinken lassen, Brust öffnen, Blick leicht nach vorne (Kuh).',
  ...
  },
  {
    ...
    mistakes: [
      ...
      'Erzwingen, wenn die Fersen nicht erreicht werden — dann ein Kissen zwischen Waden und Oberschenkel legen.',
    ],
